...
describe('pegaArquivo::', () => {
  ...
  it('deve retornar mensagem "não há links"', async () => {
    const resultado = await pegaArquivo('C:/Users/Felipe Lindo/felipe-node/Node Basico/test/arquivos/texto1_semlinks.md')
    expect(resultado).toBe('não há links');
  })
  it('deve lançar um erro na falta de arquivo', () => {
    async function capturaErro() {
      await pegaArquivo('/C:/Users/Felipe Lindo/felipe-node/Node Basico/test/arquivos/')
